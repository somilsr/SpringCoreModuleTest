...
<div class="container-fluid">
        	<section class="section card mb-5">
            	<div class="card-body">
                	<h1 class="bg-color heading">Course Attempt</h1>
                    	...
                    	<div class="card">
                            <div class="card-body">
                                <table id="datatables" class="table table-striped table-bordered table-responsive-md" cellspacing="0" width="100%">
									...
									<c:forEach items="${courseAttemptList}" var="sl">
										<tr class="odd gradeX">
											...
											<td><c:out value="${sl.courseModuleId.courseCategoryId.courseType}" />::<c:out value="${sl.courseModuleId.name}" /></td>
											<td><fmt:formatDate value="${sl.attemptDate}" pattern="dd-MMM-yyyyy"/></td>
											<td><c:out value="${sl.timeTaken}" /></td>
